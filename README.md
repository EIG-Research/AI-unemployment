...
This repository contains the data and code to generate estimates in "AI and Jobs: The Final Word (Until the Next One)" analysis [link](https://eig.org/ai-and-jobs-the-final-word/), and the accompanying Agglomerations post [link](https://agglomerations.substack.com/p/all-quiet-on-the-ai-front). Accurate as of time of publication, August 10th, 2025. Contact sarah@eig.org and nathan@eig.org with any questions.
